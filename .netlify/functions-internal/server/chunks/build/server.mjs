...
import { getCurrentScope, onScopeDispose, defineComponent, shallowRef, getCurrentInstance as getCurrentInstance$1, provide, cloneVNode, h, createElementBlock, hasInjectionContext, inject, toRef, isRef, computed, resolveComponent, unref, toValue, onServerPrefetch, reactive, defineAsyncComponent, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, watch, withCtx, mergeProps, createTextVNode, toDisplayString as toDisplayString$1, onErrorCaptured, resolveDynamicComponent, effectScope, nextTick, isReadonly, isShallow, isReactive, toRaw, customRef } from 'vue';
import { y as defuFn, z as klona, A as hasProtocol, B as parseQuery, s as joinURL, C as parseURL, i as encodePath, D as decodePath, E as getContext, F as parsePath, G as withQuery, H as isScriptProtocol, I as withTrailingSlash, J as withoutTrailingSlash, K as sanitizeStatusCode, $ as $fetch$1, L as baseURL, M as hash, N as defu, n as createError$1, O as executeAsync, P as getRequestURL, Q as getRequestHeader, R as getCookie, S as parse$1, T as isEqual, U as createDefu, V as setCookie, W as deleteCookie, X as isEqual$1 } from '../nitro/nitro.mjs';
...
const unhead_P4f7OimbHMbaeP678NZlIQgDG3ObVcjq2f8j_ocxC98 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const matcher = /* @__PURE__ */ (() => {
  const $0 = { redirect: "/sitemap_index.xml" };
  return (m, p) => {
    let r = [];
...
const component_45stub8eBtDYmAJs4Uo_RtSlxWWWjHtFU4sDmXqiMxvbS6jck = {};
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-q1cVnkrV.mjs')
  },
  {
    name: "index___ar",
    path: "/ar",
  ...
  },
  {
    ...
    path: "/ar/sitemap.xml",
    component: component_45stub8eBtDYmAJs4Uo_RtSlxWWWjHtFU4sDmXqiMxvbS6jck
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/en/sitemap.xml",
...
const _0_siteConfig_WU_8Z8ZCQf2ADd0VrcUItFfWK7hsCN_wPjQy14_EMDE = /* @__PURE__ */ defineNuxtPlugin({
...
const revive_payload_server_MwDsX3fpYVOx0PHUIzdJay5K7b8h3IKRY7Hm1LqP3Ew = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import('./index-DOoZI5-n.mjs').then((r) => r["default"] || r.default || r));
...
const colors_dOQ_G901IcdWYmxVSoQNVF_JoJXGA0jwkpahImOCuQ4 = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_2uROryybbWcpOT2bGLSUOLPkZKQ_XM_T4JWacQXP9lk = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const i18n_6MC_NSQdEFZkUkp1U8YVuIE2Ds3WinuayaXtCBdgOiE = /* @__PURE__ */ defineNuxtPlugin({
  ...
  ar: [
    {
      ...
      load: () => import(
        './ar-SY-xOKPoNKJ.mjs'
        /* webpackChunkName: "locale_ar_45SY_46json_1f1c8282" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-US-D0Av2uvx.mjs'
        /* webpackChunkName: "locale_en_45US_46json_0f65d1c8" */
      ),
      cache: true
    }
  ],
  tr: [
    {
      ...
      load: () => import(
        './tr-TR-DulHx-aa.mjs'
        /* webpackChunkName: "locale_tr_45TR_46json_16d947cb" */
      ),
      cache: true
    }
  ]
...
var define_I18N_LOCALE_HASHES_default$1 = { ar: "bbd0a36e", en: "bbd0a36e", tr: "bbd0a36e" };
...
const switch_locale_path_ssr_eTOgoSeS_ogPVvEA_YhGLOAwMvFGMjVGpXNVMUbI0kM = /* @__PURE__ */ defineNuxtPlugin({
...
const route_locale_detect_SDHnxgbDeOPkLNZq_kdskSs1Y6vxrmGA62lf5uNlKY0 = /* @__PURE__ */ defineNuxtPlugin({
...
const preload_wbZ_KZyYtW3_lr5NgsSFpBFhBl_6R0DdIH_KNrqeIHY = /* @__PURE__ */ defineNuxtPlugin({
...
var define_I18N_LOCALE_HASHES_default = { ar: "bbd0a36e", en: "bbd0a36e", tr: "bbd0a36e" };
const i18n_uKMe_4WrClXCbRfpkPVBq5sdI0iiDzsS_n3a01K7_LI = /* @__PURE__ */ defineNuxtPlugin({
  name: "i18n:plugin",
  parallel: false,
  async setup(_nuxt) {
    let __temp, __restore;
...
const ssg_detect_Y0l4UD_FeJzee2F_t2gPa803KOiSpZar2bJYAkm9J0c = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_P4f7OimbHMbaeP678NZlIQgDG3ObVcjq2f8j_ocxC98,
  plugin,
  _0_siteConfig_WU_8Z8ZCQf2ADd0VrcUItFfWK7hsCN_wPjQy14_EMDE,
  revive_payload_server_MwDsX3fpYVOx0PHUIzdJay5K7b8h3IKRY7Hm1LqP3Ew,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  colors_dOQ_G901IcdWYmxVSoQNVF_JoJXGA0jwkpahImOCuQ4,
  plugin_2uROryybbWcpOT2bGLSUOLPkZKQ_XM_T4JWacQXP9lk,
  plugin_server_Xs6Qmmnj08ovR8IqXNojBsfLuFLmb5XiDvukztCrL0I,
  i18n_6MC_NSQdEFZkUkp1U8YVuIE2Ds3WinuayaXtCBdgOiE,
  switch_locale_path_ssr_eTOgoSeS_ogPVvEA_YhGLOAwMvFGMjVGpXNVMUbI0kM,
  route_locale_detect_SDHnxgbDeOPkLNZq_kdskSs1Y6vxrmGA62lf5uNlKY0,
  preload_wbZ_KZyYtW3_lr5NgsSFpBFhBl_6R0DdIH_KNrqeIHY,
  i18n_uKMe_4WrClXCbRfpkPVBq5sdI0iiDzsS_n3a01K7_LI,
  ssg_detect_Y0l4UD_FeJzee2F_t2gPa803KOiSpZar2bJYAkm9J0c
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-Dsp_UCaS.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-67a0c64f><h1 class="error-code" data-v-67a0c64f>${ssrInterpolate(unref(error)?.statusCode ?? 500)}</h1><p class="error-message" data-v-67a0c64f>${ssrInterpolate(unref(errorMessage))}</p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("error.goHome"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref(t)("error.goHome")), 1)
            ];
          }
        }),
        _: 1
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-67a0c64f"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.4_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@parcel+wat_pmpi3opbtkejos3i5cjztmyrza/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useRuntimeConfig as a, useHead as b, useRequestEvent as c, useI18n as d, entry_default as default, useSeoMeta as e, __nuxt_component_0$1 as f, useRoute as g, useLocalePath as h, __nuxt_component_1$1 as i, appConfig as j, useAppConfig as k, useState as l, useSwitchLocalePath as m, useAsyncData as n, useNuxtApp as u };
